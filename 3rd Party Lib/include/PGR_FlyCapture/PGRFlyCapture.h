...
//   necessary but can be useful in specific applications.  For example, setting
//   uiTimeout to be 0 will result in non-blocking grab call.
//
// Arguments:
//   context   - The FlyCaptureContext associated with the camera to be queried.
...
//   iQuality  - The image quality (0-100) of the saved image. This value is
//		 only applicable when using FLYCAPTURE_FILEFORMAT_JPG. If no
//		 value is passed in, the default setting is 85.
//
// Returns:
//   A FlyCaptureError indicating the success or failure of the function.
//
